        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsesId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Addresses", x => x.AddressId);
                    table.ForeignKey(
                        name: "FK_Addresses_Users_UsesId",
                        column: x => x.UsesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Catalogs_Books", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Catalogs_Books_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Catalogs_Books_Catalogs_CatalogId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsesId = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cart_Items", x => x.ItemId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cart_Items_Shopping_Carts_CartId",
                        column: x => x.CartId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Catalogs_Books_BookId",
                table: "Catalogs_Books",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_Catalogs_Books_CatalogId",
                table: "Catalogs_Books",
                column: "CatalogId");
